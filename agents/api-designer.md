...
```javascript
// Search for API design patterns and decisions
search_memory(query="API design [endpoint/feature] pattern", limit=10)
search_memory(query="REST GraphQL [use case] decision", limit=5)
```
