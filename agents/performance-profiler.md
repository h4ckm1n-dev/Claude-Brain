...
```javascript
// Search for performance optimizations and bottlenecks
search_memory(query="performance optimization [technology/feature]", limit=10)
search_memory(query="bottleneck [component] solution", limit=5)
```
