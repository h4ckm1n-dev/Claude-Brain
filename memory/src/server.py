...
# Temporal Query Endpoints (Phase 2.2)

@app.get("/temporal/valid-at")
...
@app.post("/temporal/memories/{memory_id}/mark-obsolete")
...
@app.get("/temporal/graph/{memory_id}/related-at")
...
# Analytics & Pattern Detection Endpoints (Phase 3.1)
...
@app.get("/analytics/error-trends")
...
# Recommendation Engine Endpoints (Phase 3.1)

@app.get("/recommendations/{memory_id}")
...
@app.post("/recommendations/patterns-for-error")
...
@app.get("/recommendations/preventive-patterns")
...
@app.get("/recommendations/documentation-topics")
...
@app.get("/recommendations/co-access/stats")
async def get_co_access_stats():
...
@app.post("/recommendations/co-access/reset")
...
# Audit Trail Endpoints (Phase 4.2)

@app.get("/audit/{memory_id}")
...
@app.post("/memories/{memory_id}/undo")
